    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < SUM_NUM; i++) {
            ...
            if (i == mCurrStateNum) {// 当前
                mStairRectF.set(startXP + i * floorHeight, startYP - (j + 1) * floorHeight * mCurrAnimatedValue, right, startYP);
            } else {
                mStairRectF.set(startXP + i * floorHeight, startYP - (j + 1) * floorHeight - offsetHV, right, startYP);
            }
