 ...
 * @date 2020/06/29
 */
public final class DialogText extends AppCompatDialog {
    ...
    private DialogText(Context context, Builder builder) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            AppCompatAutoCompleteTextView contentView = findViewById(R.id.dialog_param);
            AppCompatTextView nameView = findViewById(R.id.dialog_content);
            ...
            if (nameView != null) {
                nameView.setText(contentText);
                nameView.setTextColor(contentColor);
                nameView.setTextSize(contentTextSize);
                if (contentColor1 != 0) {
                    nameView.setTextColor(context.getResources().getColor(contentColor1, context.getTheme()));
                }
            }
            if (affirmView != null) {
                ...
                if (affirmListener != null) {
                    affirmView.setOnClickListener(v -> {
                        affirmListener.ok(dialog, String.valueOf(contentView.getText()));
                        contentView.setText("");
                    });
                } else {
                    affirmView.setOnClickListener(v -> {
            ...
            Log.e("dialog异常", String.valueOf(e.getMessage()));
        }
    }
    ...
    public static final class Builder {
        ...
        public <T> Builder setTitleH2Text(T msg) {
        ...
        public Builder setTitleH2TextColor(String id) {
        ...
        public Builder setTitleH2TextColor(@ColorRes int contentColor1) {
        ...
        public Builder setTitleH2TextSize(@Size int id) {
        ...
        public Builder setQuitText(String quitText) {
        ...
        public Builder setQuitTextSize(@Size int quitTextSize) {
            this.quitTextSize = quitTextSize;
            return builder;
        }

        public DialogText build() {
            try {
                synchronized (DialogText.class) {
                    return new DialogText(context, builder);
                }
            } catch (Exception e) {
                return new DialogText(context, builder);
            }
    ...
    public interface AffirmListener {
        void ok(AppCompatDialog dialog, String msg);
    }
