...
public class Labels {
    ...
    public Style style;//轴标签的 CSS 样式
    public Float x;//相对于坐标轴刻度线的水平偏移。 默认是：0.
    public Float y;//相对于坐标轴刻度线的垂直平偏移。 默认是：null.
    public Boolean useHTML;//HTML渲染

    public Labels align(String prop) {
        align = prop;
        return this;
    }

    public Labels autoRotation(Object prop) {
        autoRotation = prop;        
        return this;
    }

    public Labels autoRotationLimit(Float prop) {
        autoRotationLimit = prop;
        return this;
    }

    public Labels distance(Float prop) {
        distance = prop;
        return this;
    }

    public Labels enabled(Boolean prop) {
        enabled = prop;
        return this;
    }

    public Labels format(String prop) {
        format = prop;
        return this;
    }

    public Labels formatter(String prop) {
    ...
    public Labels padding(Float prop) {
        padding = prop;
        return this;
    }

    public Labels rotation(Float prop) {
        rotation = prop;
        return this;
    }

    public Labels staggerLines(Integer prop) {
        staggerLines = prop;
        return this;
    }

    public Labels step(Integer prop) {
        step = prop;
        return this;
    }

    public Labels style(Style prop) {
        style =  prop;
        return this;
    }

    public Labels x(Float prop) {
        x = prop;
        return this;
    }

    public Labels y(Float prop) {
        y = prop;
        return this;
    }

    public Labels useHTML(Boolean prop) {
        useHTML = prop;
        return this;
    }
}
