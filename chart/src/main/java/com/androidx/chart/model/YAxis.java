...
public class YAxis {
    ...
    public Labels labels;//用于设置 y 轴文字相关的
    ...
    public YAxis title(Title prop) {
        title = prop;
        return this;
    }

    public YAxis plotBands(PlotBandsElement[] prop) {
        plotBands = prop;
        return this;
    }

    public YAxis plotLines(PlotLinesElement[] prop) {
        plotLines = prop;
        return this;
    }

    public YAxis categories(String[] prop) {
        categories = prop;
        return this;
    }

    public YAxis reversed(Boolean prop) {
        reversed = prop;
        return this;
    }

    public YAxis gridLineWidth(Float prop) {
        gridLineWidth = prop;
        return this;
    }

    public YAxis gridLineColor(String prop) {
        gridLineColor = prop;
        return this;
    }

    public YAxis gridLineDashStyle(String prop) {
        gridLineDashStyle = prop;
        return this;
    }

    public YAxis alternateGridColor(String prop) {
        alternateGridColor = prop;
        return this;
    }

    public YAxis gridLineInterpolation(String prop) {
        gridLineInterpolation = prop;
        return this;
    }

    public YAxis labels(Labels prop) {
        labels = prop;
        return this;
    }

    public YAxis lineWidth(Float prop) {
        lineWidth = prop;
        return this;
    }

    public YAxis lineColor(String prop) {
        lineColor = prop;
        return this;
    }

    public YAxis off(Float prop) {
        off = prop;
        return this;
    }

    public YAxis allowDecimals(Boolean prop) {
        allowDecimals = prop;
        return this;
    }

    public YAxis max(Float prop) {
        max = prop;
        return this;
    }

    public YAxis min(Float prop) {
        min = prop;
        return this;
    }

    public YAxis tickPositions(Object[] prop) {
        tickPositions = prop;
        return this;
    }

    public YAxis visible(Boolean prop) {
        visible = prop;
        return this;
    }

    public YAxis opposite(Boolean prop) {
        opposite = prop;
        return this;
    }

    public YAxis tickInterval(Integer prop) {
        tickInterval = prop;
        return this;
    }

    public YAxis crosshair(Crosshair prop) {
        crosshair = prop;
        return this;
    }

    public YAxis stackLabels(String prop) {
        stackLabels = prop;
        return this;
    }

    public YAxis tickWidth(Float prop) {
        tickWidth = prop;
        return this;
    }

    public YAxis tickLength(Float prop) {
        tickLength = prop;
        return this;
    }

    public YAxis tickPosition(String prop) {
        tickPosition = prop;
        return this;
    }
