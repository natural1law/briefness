...
Java_com_androidx_http_api_NetHttp_00024Builder_host(JNIEnv *env, jobject /* this */, jstring host,
                                                     jstring port) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_androidx_http_api_NetHttp_00024Builder_hosts(JNIEnv *env, jobject /* this */,
                                                      jstring host) {
    jclass String_clazz = env->FindClass("java/lang/String");
    jmethodID concat_methodID = env->GetMethodID(String_clazz, "concat",
                                                 "(Ljava/lang/String;)Ljava/lang/String;");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_androidx_http_net_WebSocketRequest_hosts(JNIEnv *env, jclass /* this */, jstring host,
                                                  jstring port) {
    jclass String_clazz = env->FindClass("java/lang/String");
    jmethodID concat_methodID = env->GetMethodID(String_clazz, "concat",
                                                 "(Ljava/lang/String;)Ljava/lang/String;");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_androidx_http_net_WebSocketRequest_host(JNIEnv *env, jclass  /* this */, jstring host,
                                                 jstring port) {
    jclass String_clazz = env->FindClass("java/lang/String");
    jmethodID concat_methodID = env->GetMethodID(String_clazz, "concat",
                                                 "(Ljava/lang/String;)Ljava/lang/String;");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_androidx_http_net_WebSocketRequest_init(JNIEnv *env, jclass /* this */, jstring id,
                                                 jstring user, jstring pass, jstring project) {
    jclass String_clazz = env->FindClass("java/lang/String");
    jmethodID concat_methodID = env->GetMethodID(String_clazz, "concat",
                                                 "(Ljava/lang/String;)Ljava/lang/String;");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_androidx_http_net_WebSocketRequest_publicKey(JNIEnv *env, jclass /* this */) {
...
Java_com_androidx_http_net_WebSocketRequest_error(JNIEnv */* this */, jclass /* this */) {
    return -2;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_androidx_http_net_WebSocketRequest_fail(JNIEnv */* this */, jclass /* this */) {
    return -1;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_androidx_http_net_WebSocketRequest_success(JNIEnv */* this */, jclass /* this */) {
    return 0;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_androidx_http_net_WebSocketRequest_msg(JNIEnv */* this */, jclass /* this */) {
    return 1;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_androidx_http_net_WebSocketRequest_offline(JNIEnv */* this */, jclass /* this */) {
    return 2;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_androidx_http_net_WebSocketRequest_online(JNIEnv */* this */, jclass /* this */) {
    return 3;
}