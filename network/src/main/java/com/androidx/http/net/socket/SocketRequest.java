...
public final class SocketRequest implements Enqueue {
    ...
    @Override
    public boolean send(int type, @NonNull byte[] msg) {
    ...
    @Override
    public boolean send(@NonNull byte[] msg) {
        if (okWebSocket == null) return false;
        else return okWebSocket.send(ByteString.of(msg));
    }

    @Override
    public boolean send(@NonNull ByteString msg) {
        if (okWebSocket == null) return false;
    ...
    @NonNull
    @Override
    public Enqueue setActionListener(@NonNull ActionListener listener) {
    ...
    @NonNull
    @Override
    public Enqueue setMsgCallback(@NonNull MsgCallback callback) {
    ...
    @NonNull
    @Override
    public Enqueue setLoginCallback(@NonNull LoginCallback callback) {
